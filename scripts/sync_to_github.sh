...
SRC="/home/repo/own/Microsoft/azure-agent-blueprint"
DST="/tmp/azure-agent-blueprint-push"
...
cp -r "$SRC/src" "$SRC/infra" "$SRC/tests" "$SRC/scripts" "$SRC/site" "$DST/" 2>/dev/null || true
